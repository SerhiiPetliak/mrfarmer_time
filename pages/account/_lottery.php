...
<b>Лотерея</b> - это такая игра :) Всего имеется <?=$num_bil; ?> билетов. После того, как все билеты будут проданы состоится розыгрыш счастливых билетов. Система случайным образом выберет 3 номера счастливых билетов и зачислит им призы. <BR />
...
<BR />
<a href="/account/lottery/winners"><font color='green'>Список завершенных лотерей</font></a>
<BR /><BR />
...
<input type="submit" name="set_lottery" class="btn_8" value="Купить билет" style="padding:7px;" />
