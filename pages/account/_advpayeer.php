...
<div class="text_right">
	...
	<div class="text_pages_content">
		...
		if(htmlspecialchars($_POST['method']) === 'payeer') {
			?>
			<div class="s-bk-lf">
				<div class="acc-title">Пополнение рекламного счета</div>
			</div>

			<div class="silver-bk">

				<div id="error" class="err"></div>
				<div class="title aligncenter">Пополнение рекламного счета через <img class="payment_top" height="33" alt="" src="/img/payeer.png"></div>
				<div class="line_divider"></div>
				<form method="POST" action="/account/advpayeer">
					<div class="adding_funds">
						...
						<input class="subm_button topup_button add_wrap_r button-green3" id="submit" type="submit" value="Пополнить баланс" >
						<div class="s_divide"></div>
						<div class="clear"></div>
		...
		<div class="silver-bk">
			...
			<div id="error" class="err"></div>
			<div class="title aligncenter">Пополнение счёта через <img class="payment_top" height="33" alt="" src="/img/payeer.png"></div>
			<div class="line_divider"></div>
			<form method=GET action="http://www.free-kassa.ru/merchant/cash.php">
				<div class="adding_funds">
					...
					<input class="subm_button topup_button add_wrap_r button-green " type="submit" id="submit" value="Пополнить баланс" >
	...
	<center>
		<form method="GET" action="//payeer.com/api/merchant/m.php">
			<div>
				...
				<input type="submit" name="m_process" class="button-green" style="width: auto !important; border: none; border-radius: 3px;" value="Перейти к оплате счета" />
			</div>
		</form>
	</center>
	</div>
...
<div class="payment_m">
	<label for="payment_payeer">
		<div class="p_logo">
			<img height="33" alt="" src="/img/payeer.png">
		</div>
	</label>
