...
$data = $db->FetchArray();
if($data['all_trees'] == 0){?>
	<div style="color: red;text-align: center;font-size: 12pt;margin-top: 10px;display: block;font-weight: bold;">Играть могут только те пользователи, у которых есть хотя бы один из персонажей!</div>
<?}else{?>
<?
