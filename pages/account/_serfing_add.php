...
<div id="catblock2">
    ...
    <span id="cattitle3" class="cattitle-open hidden" style="display: none;" onclick="showhide(3);">Расширенный выбор целевой аудитории, таргетинг (+ <?php echo SERF_PRICE_TARGET; ?> бак.)</span>
...
?>
<center>
    <div class="button-green" title="Принять изменения" onclick="SbmForm();">Сохранить</div>
</center>
<?php
}
else
...
?>
<center>
    <div class="button-green" title="Разместить рекламу" onclick="SbmForm();">Добавить</div>
</center>
<?php
}
?>
