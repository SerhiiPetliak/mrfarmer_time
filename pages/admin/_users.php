...
$type = ($_POST["type"] == 1) ? "-1" : "+1";
	...
	$db->Query("SELECT *, INET_NTOA(db_users_a.ip) uip FROM db_users_a, db_users_b WHERE db_users_a.id = db_users_b.id AND db_users_b.id = '$eid' LIMIT 1");
	echo "<center><b>Персонаж добавлен</b></center><BR />";
...
<table width="100%" border="0">
  ...
  <tr bgcolor="#efefef">
    <td style="padding-left:10px;">Яиц на балансе (Бобер):</td>
    <td width="200" align="center"><?=$data["a_b"]; ?></td>
  </tr>
  <tr>
    <td style="padding-left:10px;">Яиц на балансе (Кот):</td>
    <td width="200" align="center"><?=$data["b_b"]; ?></td>
  </tr>
  <tr bgcolor="#efefef">
    <td style="padding-left:10px;">Яиц на балансе (Бегемот):</td>
    <td width="200" align="center"><?=$data["c_b"]; ?></td>
  </tr>
  <tr>
    <td style="padding-left:10px;">Яиц на балансе (Заяц):</td>
    <td width="200" align="center"><?=$data["d_b"]; ?></td>
  </tr>
  <tr bgcolor="#efefef">
    <td style="padding-left:10px;">Яиц на балансе (Волк):</td>
    <td width="200" align="center"><?=$data["e_b"]; ?></td>
  </tr>
  
  
  <tr>
    <td style="padding-left:10px;">Персонажей (Бобер):</td>
  ...
  <tr bgcolor="#efefef">
    <td style="padding-left:10px;">Персонажей (Кот):</td>
    <td width="200" align="center">
  ...
  <tr>
    <td style="padding-left:10px;">Персонажей (Бегемот):</td>
    <td width="200" align="center">
  ...
  <tr bgcolor="#efefef">
    <td style="padding-left:10px;">Персонажей (Заяц):</td>
    <td width="200" align="center">
  ...
  <tr>
    <td style="padding-left:10px;">Персонажей (Волк):</td>
    <td width="200" align="center">
  ...
  <tr bgcolor="#efefef">
    <td style="padding-left:10px;">Собрано за все время (Бобер):</td>
    <td width="200" align="center"><?=$data["all_time_a"]; ?></td>
  </tr>
  <tr>
    <td style="padding-left:10px;">Собрано за все время (Кот):</td>
    <td width="200" align="center"><?=$data["all_time_b"]; ?></td>
  </tr>
  <tr bgcolor="#efefef">
    <td style="padding-left:10px;">Собрано за все время (Бегемот):</td>
    <td width="200" align="center"><?=$data["all_time_c"]; ?></td>
  </tr>
  <tr>
    <td style="padding-left:10px;">Собрано за все время (Заяц):</td>
    <td width="200" align="center"><?=$data["all_time_d"]; ?></td>
  </tr>
  <tr bgcolor="#efefef">
    <td style="padding-left:10px;">Собрано за все время (Волк):</td>
...
<table cellpadding='3' cellspacing='0' border='0' bordercolor='#336633' align='center' width="99%">
  <tr bgcolor="#efefef">
	...
	<td align="center" width="75" class="m-tb"><a href="/?menu=admin4ik&sel=users&sort=3" class="stn-sort">Персонажей</a></td>
