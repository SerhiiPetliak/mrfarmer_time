...
class life_time
{
	...
	private function GetNameItem($name)
	{
		...
		{
			case 'a_t':
				return "Время: Уровень 1";
			break;

			case 'b_t':
				return "Время: Уровень 2";
			break;

			case 'c_t':
				return "Время: Уровень 3";
			break;
			
			case 'd_t':
				return "Время: Уровень 4";
			break;

			case 'e_t':
				return "Время: Уровень 5";
			break;

			case 'f_t':
				return "Время: Уровень 6";
			break;
			
			case 'g_t':
				return "Время: Уровень 7";
			break;
			
			case 'h_t':
				return "Время: Уровень 8";
			break;
